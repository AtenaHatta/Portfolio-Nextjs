  ...
  return (
    ...
    >
      <div className="flex items-center w-full h-full">
        <h1 className="text-6xl md:text-8xl pl-2 pb-8 text-gray-300">
          EXPERIENCE
        </h1>
            ...
            <div className="space-y-2 lg:space-y-4">
              <div>
                <div className="flex flex-col items-center">
                  ...
                  <div className="absolute flex items-center md:items-center justify-center w-8 h-8 transform -translate-x-1/2 -translate-y-4 bg-purple-100 border border-purple-600 rounded-full dark:border-gray-700 dark:bg-gray-700 left-1/2 sm:translate-y-0">
                      ...
                      <Link href="https://ciccc.ca/">
                        <div className="relative flex-1 mb-16 bg-white rounded shadow lg:mb-8 dark:bg-gray-900 hover:bg-purple-700">
                          ...
                          <div className="relative z-20 p-6">
                            ...
                            <p className="mt-4 mb-2 text-xl font-bold text-gray-600 text-start lg:text-end dark:text-gray-300">
              ...
              <div>
                <div className="flex flex-col items-center">
                  ...
                  <div className="absolute flex items-end justify-center w-8 h-8 transform -translate-x-1/2 -translate-y-4 bg-purple-100 border border-purple-600 rounded-full dark:border-gray-700 dark:bg-gray-700 left-1/2 sm:translate-y-0">
